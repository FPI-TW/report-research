...
Claude CLI 已於 2026-09-23 永久放棄（OAuth 過期、D-C），遷移終局 PR-M 移除了 CLI backend 與 `claude_only`
回退：問答與批次的 LLM 段全部走 DeepSeek，沒有備援。
帳號層級的失效（402 餘額不足、401 金鑰失效、連不上）會讓問答每一題失敗、sync 整批 rc=2，
