    ...
    <div className={`${styles.scroll} tf-scroll`}>
      <div className={styles.wrap}>
        ...
        <section id="ai" className={styles.section}>
          ...
          <p>本站以下內容由 <strong>DeepSeek</strong> 的大型語言模型<strong>自動生成</strong>，不是人工撰寫：</p>
          <ul className={styles.bul}>
          ...
          <p>生成時，你的<strong>提問</strong>與相關的<strong>研報內容</strong>會送往模型供應商 DeepSeek 處理，並依其服務條款處理。</p>
          <div className={styles.note}>
