...
export function KpiGrid({ progress }: { progress: Progress }) {
  ...
  return (
    <div className={styles.kpiGrid}>
      <KpiCard label="已導入報告" value={<TweenNumber value={db.reports} decimals={0} format={fmtInt} duration={600} />} suffix="篇" sub={`${db.markets.length} 個市場`} />
      <KpiCard label="總片段 CHUNKS" value={<TweenNumber value={db.chunks} decimals={0} format={fmtInt} duration={600} />} suffix="段" sub="向量片段總數" />
      <KpiCard
        label="標註進度"
